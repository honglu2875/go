...
def scalar_bf16(x, value):
    ...
    return (x.astype(jnp.float32) * jnp.asarray(value, jnp.float32)).astype(jnp.bfloat16)
...
def polar(g):
    ...
    for _ in range(5):
        ...
        b = scalar_bf16(a, -4.775) + mm(scalar_bf16(a, 2.0315), a)
        x = scalar_bf16(x, 3.4445) + mm(b, x)
