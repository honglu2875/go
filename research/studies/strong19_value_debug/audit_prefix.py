...
def audit(snapshot, directories, purpose, stop_turn):
    import numpy as np
    ...
    return dict(kind='bounded_joint_learner_prefix_audit', status='passed', snapshot=snapshot.name, purpose=purpose,
...
def main():
    ...
    result = audit(args.snapshot.resolve(), args.artifacts, args.purpose, args.stop_turn)
