...
def main():
    ...
    png = args.result.parent / 'curves.png'
    receipt = args.result.parent / 'plot.json'
    ...
    fig.suptitle('Larger fixed 9×9 corpus · paired seed 1', fontsize=16)
    fig.get_layout_engine().set(rect=(0, .075, 1, .965))
    fig.text(.02, .015,
