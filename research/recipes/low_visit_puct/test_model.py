...
class ModelTests(unittest.TestCase):
    ...
    def test_loss_gradient_matches_finite_difference(self):
        ...
        cfg={'l2':0.0001,'ownership_weight':1.5}
    ...
    def test_ownership_gradient_and_zero_coefficient_control(self):
        ...
        def loss(bias,weight):
            return model.losses({**self.params,'ownership_bias':bias},self.x,pi,z,owner,self.config,{'l2':0.,'ownership_weight':weight})[0]
        ...
        def gradient(labels):return jax.grad(model.losses,has_aux=True)(self.params,self.x,pi,z,labels,self.config,{'l2':0.,'ownership_weight':0.})[0]
