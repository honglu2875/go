...
def main():
    ...
    parent=trace_transformer({**{k:v for k,v in n.items() if k not in ('encoder_channels','encoder_depth','policy_spatial_bias','encoder_rematerialize')},'encoder':'overlap_linear'},9,128)
    ...
    report={'kind':'complete_neural_decode_budget_qualification','status':'passed','operator_snapshot':SOURCE.name,
        ...
        'position_weighted_decode':weighted,'parent_linear_encoder':parent,
