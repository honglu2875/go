...
def validate(c):
    ...
    fields(a, 'size komi scoring history games workers worker_cpus simulations cpuct max_search_edges max_game_moves dirichlet_alpha dirichlet_fraction temperature_early temperature_late temperature_moves seed actor_offset', 'actors')
