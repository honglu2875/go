...
if __package__:
    from .transformer_config import validate_model
else:
    from transformer_config import validate_model
...
def linear(x, w, c):
    ...
    precision = jax.lax.Precision.DEFAULT if c.get('linear_precision', 'highest') == 'default' else jax.lax.Precision.HIGHEST
